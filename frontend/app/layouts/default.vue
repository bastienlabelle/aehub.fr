        ...
        <aside class="w-64 min-h-screen bg-base-100 border-r border-base-300 flex flex-col">
          ...
          <nav class="flex-1 px-3 py-4">
            <ul class="menu menu-md gap-1">
              ...
              <li>
                <NuxtLink to="/clients" active-class="active">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li>
                <NuxtLink to="/quotes" active-class="active">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li>
                <NuxtLink to="/invoices" active-class="active">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const currentTheme = computed(() => isDark.value ? 'coffee' : 'retro')
