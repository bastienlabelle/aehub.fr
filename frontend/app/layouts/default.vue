          ...
          <nav class="flex-1 px-2 py-2">
            <ul class="menu menu-sm p-0 gap-0.5 w-[100%]">
              <li>
                <NuxtLink
                  to="/"
                  exact-active-class="bg-neutral-content !text-neutral hover:bg-neutral-content hover:!text-neutral"
                  active-class=""
                  class="rounded-lg font-medium text-lg text-neutral-content hover:bg-neutral-focus hover:text-neutral-content"
                >
              ...
              <li>
                <NuxtLink
                  to="/clients"
                  active-class="bg-neutral-content !text-neutral hover:bg-neutral-content hover:!text-neutral"
                  exact-active-class="bg-neutral-content !text-neutral hover:bg-neutral-content hover:!text-neutral"
                  class="rounded-lg font-medium text-lg text-neutral-content hover:bg-neutral-focus hover:text-neutral-content"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
